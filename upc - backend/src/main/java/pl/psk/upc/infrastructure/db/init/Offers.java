...
public enum Offers {
    ...
    Offers(String offerName, double price, String description, ProductType productType, boolean withDevice, OfferType offerType) {
